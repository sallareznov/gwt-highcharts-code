 ...
 * @since 1.0.0
 */
public class AreaPlotOptions extends PlotOptions<AreaPlotOptions> {
     ...
     */
    public AreaPlotOptions setFillColor(String fillColor) {
     ...
     * @return A reference to this {@link AreaPlotOptions} instance for convenient method chaining.
     */
    public AreaPlotOptions setFillColor(Color fillColor) {
     ...
     * @return A reference to this {@link AreaPlotOptions} instance for convenient method chaining.
     */
    public AreaPlotOptions setFillOpacity(Number fillOpacity) {
     ...
     * @return A reference to this {@link AreaPlotOptions} instance for convenient method chaining.
     */
    public AreaPlotOptions setLineColor(String lineColor) {
     ...
     * @return A reference to this {@link AreaPlotOptions} instance for convenient method chaining.
     */
    public AreaPlotOptions setLineColor(Color lineColor) {
