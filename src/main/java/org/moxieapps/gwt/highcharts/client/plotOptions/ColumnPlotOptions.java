 ...
 * @since 1.0.0
 */
public class ColumnPlotOptions extends PlotOptions<ColumnPlotOptions> {
     ...
     */
    public ColumnPlotOptions setBorderColor(String borderColor) {
     ...
     * @return A reference to this {@link ColumnPlotOptions} instance for convenient method chaining.
     */
    public ColumnPlotOptions setBorderColor(Color borderColor) {
     ...
     * @return A reference to this {@link ColumnPlotOptions} instance for convenient method chaining.
     */
    public ColumnPlotOptions setBorderRadius(Number borderRadius) {
     ...
     * @return A reference to this {@link ColumnPlotOptions} instance for convenient method chaining.
     */
    public ColumnPlotOptions setBorderWidth(Number borderWidth) {
     ...
     * @return A reference to this {@link ColumnPlotOptions} instance for convenient method chaining.
     */
    public ColumnPlotOptions setColorByPoint(boolean colorByPoint) {
     ...
     * @return A reference to this {@link ColumnPlotOptions} instance for convenient method chaining.
     */
    public ColumnPlotOptions setGroupPadding(Number groupPadding) {
     ...
     * @return A reference to this {@link ColumnPlotOptions} instance for convenient method chaining.
     */
    public ColumnPlotOptions setMinPointLength(Number minPointLength) {
     ...
     * @return A reference to this {@link ColumnPlotOptions} instance for convenient method chaining.
     */
    public ColumnPlotOptions setPointPadding(Number pointPadding) {
     ...
     * @return A reference to this {@link ColumnPlotOptions} instance for convenient method chaining.
     */
    public ColumnPlotOptions setPointWidth(Number pointWidth) {
