 ...
 * via the {@link PlotOptions#setMarker(Marker)} method. Example usage: <code><pre>
...
public class Marker extends Configurable<Marker> {
     ...
     * channel or a gradient, use the {@link #setFillColor(Color)} version instead.
     * 
     * @param fillColor
     *            The value to set as the 'fillColor' option of the markers.
     * @return A reference to this {@link Marker} instance for convenient method chaining.
     */
     ...
     * the color to a normal RGB hex value you can use the {@link #setFillColor(String)} version instead.
     * 
     * @param fillColor
     *            The color gradient or color with an alpha channel to set as the 'fillColor' option of the markers.
     * @return A reference to this {@link Marker} instance for convenient method chaining.
     */
     ...
     * <p/>
     * Note that this method is intended for setting the color to a simple RBG hex value. If you instead want to set a color to include an alpha
     * channel or a gradient, use the {@link #setLineColor(Color)} version instead.
     * 
     * @param lineColor
     *            The value to set as the 'lineColor' option of the markers.
     * @return A reference to this {@link Marker} instance for convenient method chaining.
     */
     ...
     * <p/>
     * Note that this method is intended for setting the color to a gradient or color that includes an alpha channel. If you instead just want to set
     * the color to a normal RGB hex value you can use the {@link #setLineColor(String)} version instead.
     * 
     * @param lineColor
     *            The color gradient or color with an alpha channel to set as the 'lineColor' option of the markers.
     * @return A reference to this {@link Marker} instance for convenient method chaining.
     */
     ...
     * 
     * @param hoverState
     *            The configuration options to use for the markers on mouse hover.
     * @return A reference to this {@link Marker} instance for convenient method chaining.
     */
     ...
     * 
     * @param selectState
     *            The configuration options to use for the markers when selected.
     * @return A reference to this {@link Marker} instance for convenient method chaining.
     */
     ...
     * {@link org.moxieapps.gwt.highcharts.client.Chart#setSymbols(org.moxieapps.gwt.highcharts.client.plotOptions.Marker.Symbol[])} options. Defaults
     * to null.
     * <p/>
     * Note that custom marker images are also supported by simply setting the "symbol" option to a URL reference. E.g.
     * 
     ...
     * 
     * @param symbol
     *            The shape or symbol for the marker.
     * @return A reference to this {@link Marker} instance for convenient method chaining.
     */
     ...
     * 
     * @param symbolURL
     *            the url of the symbol to use for the marker.
     * @return A reference to this {@link Marker} instance for convenient method chaining.
     * @since 1.6.0
     */
    ...
    /**
     * Convenience method for setting the 'symbol' option for markers to a FontAwesome icon. Equivalent to:
     * 
     * <pre>
     * <code>
     *     marker.setOption("symbol", "text:\uf00c");
     * </code>
     * </pre>
     * 
     * Sets the marker to use a custom symbol from a FontAwesome icon. Note that only the unicode character
     * is needed to be passed as a parameter (need to use a plugin though). Sample usage:
     * 
     * <pre>
     * <code>
     *     chart.addSeries(
     ...
     * 
     * @param iconUnicode
     *            the unicode for the icon
     * @return A reference to this {@link Marker} instance for convenient method chaining.
     * @since 1.7.0
     */
    public Marker setIcon(String iconUnicode) {
	return this.setOption("symbol", "text:" + iconUnicode);
    }
}
