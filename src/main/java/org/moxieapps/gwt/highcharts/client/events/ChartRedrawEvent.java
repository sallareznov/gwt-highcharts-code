...
public class ChartRedrawEvent {
     ...
     * 
     * @param event
     *            The native javascript object containing the details of the original event that was fired.
     */
    public ChartRedrawEvent(JavaScriptObject event, JavaScriptObject chart) {
	this.event = event;
	this.chart = chart;
    }
