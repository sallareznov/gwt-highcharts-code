...
/**
 * A configurable class that can be used to represent custom title options for
 * the chart, which can then be set the chart (via the
 * {@link Chart#setChartTitle(ChartTitle)} method.) Example usage: <code><pre>
 *   chart.setChartTitle(
 *     new ChartTitle()
...
public class ChartTitle extends Configurable<ChartTitle> {
	...
	/**
	 * An enumeration of supported chart title horizontal alignment types, which
	 * can be passed to methods like
	 * {@link ChartTitle#setAlign(ChartTitle.Align)}.
	 */
	public enum Align {
	...
	/**
	 * An enumeration of supported chart title vertical alignment types, which
	 * can be passed to methods like
	 * {@link ChartTitle#setVerticalAlign(ChartTitle.VerticalAlign)}.
	 */
	 ...
	 * "right". Defaults to {@link ChartTitle.Align#CENTER}.
	 *
	 * @param align
	 *            The horizontal alignment of the title.
	 * @return A reference to this {@link ChartTitle} instance for convenient
	 *         method chaining.
	 */
	 ...
	 *
	 * @param floating
	 *            'true' to float the title above the plot area, or 'false' (the
	 *            default) to make space for it.
	 * @return A reference to this {@link ChartTitle} instance for convenient
	 *         method chaining.
	 */
	 ...
	 *
	 * @param margin
	 *            The margin between the title and the plot area, or if a
	 *            subtitle is present, the margin between the subtitle and the
	 *            plot area.
	 * @return A reference to this {@link ChartTitle} instance for convenient
	 *         method chaining.
	 */
	 ...
	 * {@link #setAlign(org.moxieapps.gwt.highcharts.client.ChartTitle.Align)},
	 * {@link #setX(Number)}, and {@link #setY(Number)} for text alignment.
	 * Defaults to:
	 * <ul>
	 * <li>color: '#3E576F'</li>
	 * <li>fontSize: '16px'</li>
	...
	public ChartTitle setStyle(Style style) {
		return this.setOption("style", style != null ? style.getOptions()
				: null);
	}

	/**
	 * Convenience method for setting the 'text' option of the title. Equivalent
	 * to:
	 * 
	 * <pre>
	 * <code>
	 ...
	 * <p/>
	 * Note to disable an axis title from being displayed completely, simply set
	 * the text to "null". (This can also be accomplished more simply by just
	 * setting the title text to null directly on the axis via the
	 * {@link Axis#setAxisTitleText(String)} method.)
	 *
	 * @param text
	 ...
	 * "bottom". Defaults to "top". Defaults to
	 * {@link ChartTitle.VerticalAlign#TOP}.
	 *
	 * @param verticalAlign
	...
	public ChartTitle setVerticalAlign(VerticalAlign verticalAlign) {
		return this.setOption("verticalAlign",
				verticalAlign != null ? verticalAlign.toString() : null);
	}
	 ...
	 * </pre>
	 * 
	 * The x position of the title relative to the alignment within the spacing
	 * set on the chart controlled via {@link Chart#setSpacingLeft(Number)} and
	 * {@link Chart#setSpacingRight(Number)}. Defaults to 0.
	 *
	 * @param x
	 *            The x position of the title, relative to the chart's spacing.
	 * @return A reference to this {@link ChartTitle} instance for convenient
	 *         method chaining.
	 */
	 ...
	 * </pre>
	 * 
	 * The y position of the title relative to the alignment within the spacing
	 * set on the chart controlled via {@link Chart#setSpacingTop(Number)} and
	 * {@link Chart#setSpacingBottom(Number)}. Defaults to 25.
	 *
	 * @param y
	 *            The y position of the title, relative to the chart's spacing.
	 * @return A reference to this {@link ChartTitle} instance for convenient
	 *         method chaining.
	 */
